...
public class BasicActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ToolTip toolTip = new ToolTip().setTitle("Welcome!").setDescription(
		...
		mTutorialHandler = TourGuide
				...
				.setToolTip(toolTip)
				.setOverlay(
						new Overlay().setBackgroundColor(Color
								.parseColor("#66FF0000"))).playOn(button);

		mTutorialHandler.initContext(BasicActivity.this);
